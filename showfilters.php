...
/////collect variables
        ...
        var czoow = document.querySelector("#getcanwidthfilterszoomy");
var czooh = document.querySelector("#getcanheightfilterszoomy");
 var zwx = parseInt(window.getComputedStyle(czoow,null).width);
  var  zhx= parseInt(window.getComputedStyle(czooh,null).height);


 
 

  if(iW > iH){ zw=zwx; zh= zwx * iH/iW; }else{ zh=zhx;   zw= zhx * iW/iH }
if (Tamefilters > 12){
...
if(pushzoom == 1){
newc.style.width=zw;
   newc.style.height=zh;
   norw.style.width=zw;
   norw.style.height=zh;
}else{ 
 newc.style.height=zh;
   newc.style.width=zw; 
 norw.style.height=zh;
...
document.getElementById("zaax").style.height=zh;
