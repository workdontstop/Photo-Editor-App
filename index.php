...
require('phpopen.php');
                        ...
                        if(   !$_SESSION['numuser'] ){
                                    ...
                                    $_SESSION['superthemetypevalue']=2;
...
$_POST['c']=0;
                          ...
                          $_SESSION['cl'] = "#dddddd";  $_SESSION['check'] = 0;
                                                                              
                                  $_SESSION['numuser'] = 18;  $_SESSION['user'] = "Guest";  
  
                              $_SESSION['theme'] = 0;
                                     
                                       $_SESSION['nameuser'] = "Regular Joe";

                                         $_SESSION['quoteuser'] = "happy";
...
<div id="getcanheightfilters"   style="position: fixed;top:9em; height:62%;"> </div>
<div id="getcanwidthfilters"  class=" "   style="position: fixed;top:9em; width:65%"></div>
<div id="getcanheightfilterszoomy"   style="position: fixed;top:9em; height:100%;"> </div>
<div id="getcanwidthfilterszoomy"  class=" "   style="position: fixed;top:9em; width:100%"></div>
...
<div id="getcanheightquick"   style="position: fixed;top:9em ; height:90%;"></div>
<div id="getcanwidthquick"  class=" "   style="position: fixed;top:9em ;  width:90%"></div>
...
<div class="col-xs-12 supertheme"   style="padding:0px;height:100%;overflow:hidden;margin-top:-1px">
...
#superthemebutton{background-color:<?php echo  $_SESSION['cl']; ?>;color:#000000; padding: 5px; border-bottom-left-radius:4px; border-top-left-radius:4px;  -moz-box-shadow: 0 0 2.5px<?php echo  $_SESSION['cl']; ?>; -webkit-box-shadow: 0 0 2.5px<?php echo  $_SESSION['cl']; ?>;box-shadow: 0 0 2.5px<?php echo  $_SESSION['cl']; ?>; }
 ...
 <div class=" col-xs-12 col-sm-12 za  "  style="padding:0px">  <div class=" "  id="launchbox"
  style="margin:auto;text-align:center;margin-top:26vh"> 
